...
RED_RINGS_PART_CONTROL_MAX_DEG = 0.16
RED_RINGS_PART_DEADBAND_PX = 12.0
RED_RINGS_PART_FINE_RADIUS_PX = 35.0
RED_RINGS_PART_FINE_CONTROL_MAX_DEG = 0.08
...
RED_PANEL_CENTER_CONTROL_MAX_DEG = 0.14
RED_PANEL_CENTER_FINE_CONTROL_MAX_DEG = 0.07
...
# if the camera/laser mount changes.  Target height is used as a rough range
# estimate: far/small target -> far point, near/large target -> near point.
...
RED_RINGS_SAFE_CONTROL_MAX_DEG = 0.14
PAPER_CENTER_CONTROL_MAX_DEG = 0.12
FRAME_PART_CONTROL_MAX_DEG = 0.14
